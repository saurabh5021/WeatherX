...
public class HomeActivity extends AppCompatActivity {
    private EditText et_get_City_Name;
    private TextView tv_date_and_time, tv_day_max_temp, tv_day_min_temp, tv_temp, tv_feels_like, tv_weather_type, tv_pressure, tv_humidity, tv_wind_speed, tv_sunrise, tv_sunset_speed, tv_temp_farenhite;
    private ImageView iv_weather_icon, iv_weather_bg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (et_get_City_Name == null){
            Toast.makeText(HomeActivity.this, "Your city not found,Please enter the city name", Toast.LENGTH_SHORT).show();
        }else {
            fetchWeather();
        }
    ...
    private void fetchWeather(){
        String url = "https://api.openweathermap.org/data/2.5/weather?q="+cityName+"&appid="+"5ac926c64075e6b466d99658bdb50c26";
        JsonObjectRequest jsonObjectRequest =new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                et_get_City_Name.setError("Please Enter Valid City Name");
                dialog.dismiss();
            }
        });
